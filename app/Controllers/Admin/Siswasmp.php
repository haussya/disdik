...
class Siswasmp extends BaseController
{
    ...
    {
        return view('admin/datasiswasmp', [
            'title'        => 'Data Siswa',
    ...
    public function tambah()
    {
        ...
        return view('admin/tambahdatasiswasmp', $data);
    }
    ...
    public function simpan()
    {
        ...
        return redirect()->to('admin/datasiswasmp');
    }
    ...
    public function edit($nisn)
    {
        ...
        if ($jumlahRecord == 1) {
            ...
            return view('admin/editdatasiswasmp', $dataEdit);
        } else {
