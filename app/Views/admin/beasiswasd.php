                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/beasiswasd/edit/<?php echo $row['nisn'] ?>" class="btn btn-info">📝</a>
                                </td>
                                <td>
                                    <form action="/admin/beasiswasd/hapus/<?= $row['nisn']; ?>" method="POST" class="d-inline">
                                        <?= csrf_field(); ?>
