...
<div class="page-heading">
    ...
    <form method="POST" action="<?= base_url('/admin/beasiswasd/update') . '/' . $dataEdit['nisn'] ?>">
        <?= csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input value="<?php echo $dataEdit['keterangan'] ?>" type="text" id="keterangan" class="form-control" placeholder="Jenis Beasiswa Yang Diterima" name="keterangan">
                                            </div>
                                        </div>
