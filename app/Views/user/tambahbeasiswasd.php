...
<div class="page-heading">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/user/beasiswasd">Data Beasiswa</a></li>
    ...
    <form method="POST" action="/user/beasiswasd/simpan">
        <?= csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <form class="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="keterangan">Keterangan Beasiswa</label>
                                                <input type="text" id="keterangan" class="form-control <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" placeholder="Jenis Beasiswa Yang Diterima" name="keterangan" value="<?= old('keterangan'); ?>">
                                                <div class="invalid-feedback">
