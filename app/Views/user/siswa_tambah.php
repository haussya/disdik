...
<div class="page-heading">
    ...
    <form method="POST" action="/user/siswa">
        <?= csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="tanggal_lahir" class="form-control <?= ($validation->hasError('tanggal_lahir')) ? 'is-invalid' : ''; ?>" placeholder="Tanggal Lahir Siswa" name="tanggal_lahir" value="<?= old('tanggal_lahir'); ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="tingkat" class="form-control <?= ($validation->hasError('tingkat')) ? 'is-invalid' : ''; ?>" placeholder="tingkat" name="tingkat" value="<?= old('tingkat'); ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="alamat" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" placeholder="alamat" name="alamat" value="<?= old('alamat'); ?>">
                                                <div class="invalid-feedback">
